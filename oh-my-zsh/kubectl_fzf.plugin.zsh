# Source: https://github.com/bonnefoa/kubectl-fzf/blob/main/shell/kubectl_fzf.plugin.zsh
# Local fix: dispatch fallback before treating empty completion output as final.
